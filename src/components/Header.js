...
const Header = () => {
  ...
  return (
    <div className="flex ml-4">
      <button className="p-4 m-2 " onClick={handleToggleMenu}>
        <svg
      ...
      <button
        ...
        className="rounded-r-full border my-4 h-10  border-gray-400 w-20 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-gray-200 hover:border-gray-300 hover:bg-gray-50"
      >
        <svg
          className="w-8 ml-2 p-2"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 20 20"
      ...
      {browserSupportsSpeechRecognition && (
        <button
          type="button"
          className="inset-y-0 end-0 items-center pe-3 ml-5"
          onClick={handleSoundRecord}
        >
          <svg
      ...
      <button className="p-4 m-2 ml-[30%]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
